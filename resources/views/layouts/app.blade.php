  ...
  <nav class="navbar navbar-expand-lg bg-success-subtle">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center me-5" href="/">
        <img src="{{ asset('images/libros.png') }}" alt="logo">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link {{ request()->is('/') ? 'active fw-semibold' : '' }}" href="/">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is('libros*') ? 'active fw-semibold' : '' }}" href="/libros">Libros</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is('prestamos*') ? 'active fw-semibold' : '' }}" href="/prestamos">Prestamos</a>
          </li>
        </ul>
      </div>
    </div>
