...
<div class="d-flex justify-content-center">
  <div class="w-50 bg-body-secondary p-5 rounded-4 border border-success-subtle">
    ...
    <form action="/prestamos/editar" method="POST">
      ...
      <input type="hidden" name="id" value="<?php echo e($prestamo->id); ?>">
...
unset($__errorArgs, $__bag); ?>"
          ...
          <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option <?php if($prestamo->user_id == $user->id): ?> selected <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
          ...
          <?php $__currentLoopData = $libros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $libro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option <?php if($prestamo->libro_id == $libro->id): ?> selected <?php endif; ?>
                    value="<?php echo e($libro->id); ?>">
              <?php echo e($libro->titulo); ?>

              <?php if($libro->id != $prestamo->libro_id && !$libro->disponible): ?>
                - No disponible
              <?php endif; ?>
            </option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>"
               ...
               value="<?php echo e($prestamo->fecha_devolucion_estimada); ?>">
...
unset($__errorArgs, $__bag); ?>"
                 ...
                 id="entregado-si"
                 value="1"
                 <?php if($prestamo->entregado): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Escritorio\DW\Master FullStack\9. Programación Web con Laravel\Actividades\Actividad 2\library\resources\views/prestamos/form-editar.blade.php ENDPATH**/ ?>